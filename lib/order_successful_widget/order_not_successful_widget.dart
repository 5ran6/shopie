...
class OrderNotSuccessfulWidget extends StatelessWidget {
  String orderId;

  OrderNotSuccessfulWidget(this.orderId);

  void onIconAwesomeArrowLPressed(BuildContext context) {}

  void onGroup4Pressed(BuildContext context) => Navigator.pop(context);
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      "assets/images/icons_disapproved.png",
                                      fit: BoxFit.none,
                                    ),
                                  ),
                                ),
