...
class FlutterwavePaymentDemo extends StatefulWidget {
  FlutterwavePaymentDemo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FlutterwavePaymentDemoState createState() => _FlutterwavePaymentDemoState();
}

class _FlutterwavePaymentDemoState extends State<FlutterwavePaymentDemo> {
