...
import 'package:shopie/flutterwave/core/flutterwave_payment_manager.dart';
import 'package:shopie/flutterwave/core/mobile_money/mobile_money_payment_manager.dart';
import 'package:shopie/flutterwave/core/mpesa/mpesa_payment_manager.dart';
import 'package:shopie/flutterwave/core/pay_with_account_manager/bank_account_manager.dart';
import 'package:shopie/flutterwave/core/ussd_payment_manager/ussd_manager.dart';
import 'package:shopie/flutterwave/core/voucher_payment/voucher_payment_manager.dart';
import 'package:shopie/flutterwave/models/responses/charge_response.dart';
import 'package:shopie/flutterwave/widgets/bank_account_payment/bank_account_payment.dart';
import 'package:shopie/flutterwave/widgets/card_payment/card_payment.dart';
import 'package:shopie/flutterwave/widgets/mobile_money/pay_with_mobile_money.dart';
import 'package:shopie/flutterwave/widgets/mpesa_payment/pay_with_mpesa.dart';
import 'package:shopie/flutterwave/widgets/ussd_payment/pay_with_ussd.dart';
import 'package:shopie/flutterwave/widgets/voucher_payment/pay_with_voucher.dart';
...
class _FlutterwaveUIState extends State<FlutterwaveUI> {
  ...
  void _launchCardPaymentWidget() async {
    ...
    final ChargeResponse chargeResponse = await Navigator.push(
      this.context,
      MaterialPageRoute(builder: (context) => CardPayment(cardPaymentManager,cardPaymentManager.chargeCardRequest.fullName,cardPaymentManager.chargeCardRequest.cardNumber,cardPaymentManager.chargeCardRequest.cvv,cardPaymentManager.chargeCardRequest.expiryMonth,cardPaymentManager.chargeCardRequest.expiryYear),),
    );
    String message;
